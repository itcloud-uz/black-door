        ...
        <form method="POST" action="{{ route('control.clients.store') }}" style="display: flex; flex-direction: column; gap: 20px;">
            ...
            <div style="border-top: 1px dashed rgba(0,0,0,0.08); padding-top: 16px; margin-top: 8px;">
                ...
                <div class="form-group mb-md">
                    ...
                    <input type="text" id="admin_email" name="admin_email" class="skeuo-input" placeholder="admin@blackdoor.uz" required value="{{ old('admin_email') }}">
                </div>

                <div class="grid-2">
                    <div class="form-group">
                        <label class="form-label" for="admin_password">Tizim paroli (Kamida 4 belgi):</label>
                        <input type="password" id="admin_password" name="admin_password" class="skeuo-input" placeholder="••••••••" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="admin_pin_code">Moliya bo'limi pin-kodi (4 ta raqam):</label>
                        <input type="text" id="admin_pin_code" name="admin_pin_code" class="skeuo-input" placeholder="1234" required>
                    </div>
                </div>
            </div>
