...
class ObjectTransactionCategory extends Model
{
    use HasFactory;
    use SoftDeletes;
    ...
    {
        return $this->hasMany(ObjectTransaction::class, 'category_id');
    }
